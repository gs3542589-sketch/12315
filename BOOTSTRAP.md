...
### 1. 检查今日+昨日日志
- [ ] 读取 `memory/YYYY-MM-DD.md` 了解**今日**上下文
- [ ] 读取 `memory/YYYY-MM-DD.md`（昨天的）了解**昨日**未完成的工作
- [ ] QMD检索"近期工作 项目"关键词，确认跨天上下文

### 2. 检查MEMORY.md是否已加载
- [ ] 确认MEMORY.md已读取（所有核心流程的铁律都在里面）
- [ ] 如任务涉及"生图/发图/搜索/写作"，先查MEMORY.md对应章节再执行
